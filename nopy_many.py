...
@njit
def _njit_fill_operand(formula, struct, idx, temp_0, temp_op, temp_1, target, current_5, operand, list_formula_0, list_formula_1, count, profit, index, num_test):
        start = -1
        ...
        if valid_operand.shape[0] > 0:
            ...
            if idx + 1 == formula.shape[0]:
                ...
                for i in range(valid_operand.shape[0]):
                    if _njit_fill_operand(temp_list_formula[i], struct, idx_new, temp_0_new[i], temp_op_new, temp_1_new[i], target, current_5, operand, list_formula_0, list_formula_1, count, profit, index, num_test):
                        return True
